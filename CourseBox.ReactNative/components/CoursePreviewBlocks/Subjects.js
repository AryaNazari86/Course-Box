...
import LessonCreation from "../../pages/lessonCreation.js";
  ...
  return (
    <View style={styles.subject}>
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <LessonCreation
              closeFunc={() => setLessonModalVisible(!lessonModalVisible)}
            />
          </View>
        </View>
      </Modal>
      ...
      <TouchableOpacity style={styles.editIcon} onPress={editSubject}>
        <Feather name={editIcon} size={24} color={theme.color3} />
      </TouchableOpacity>
      {/* Subject's title */}
      <View style={styles.subjectTitle}>
        ...
        <View style={styles.subjectIcon}>
          ...
          {editable ? (
            <TouchableOpacity
              style={styles.subjectEditIconButton}
              onPress={changeIconClicked}
            >
              <Feather
                name="edit-2"
                size={35}
                color="white"
                style={styles.subjectEditIcon}
              />
            </TouchableOpacity>
          ) : null}
        </View>
